    ...
    <hero id="home">
        <div class="hero-banner-header">
            ...
            <div class="hero-nav">
                ...
                <?php if ($user_name === "Guest") {echo "<a href='views/login-register/login.php' class='a-text'><p>Login</p></a>";} ?>
                ...
                <?php if ($user_name !== "Guest") {echo "<a href='' class='a-text'><p>Logout</p></a>";} ?>
            </div>
        </div>
