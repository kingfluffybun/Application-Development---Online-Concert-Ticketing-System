            ...
            <div class="ticket-price-container">
                <div class="ticket-price" id="gen-ad">
                    ...
                    <div class="buy-ticket">
                        <a href="/views/seats/seats.php"><p>BUY TICKETS</p><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-move-right-icon lucide-move-right"><path d="M18 8L22 12L18 16"/><path d="M2 12H22"/></svg></a>
                    </div>
                </div>
